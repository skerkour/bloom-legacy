...
pub fn put((playlist_id, playlist_data, req): (Path<(uuid::Uuid)>, Json<models::UpdatePlaylistBody>, HttpRequest<api::State>)) -> FutureResponse<HttpResponse> {
    ...
    return state.db
    .send(controllers::RenamePlaylist{
