...
pub fn post(
    verify_data: web::Json<models::VerifyPendingAccountBody>,
    ...
    return Either::B(
        tokio_timer::sleep(Duration::from_millis(rng.gen_range(500, 650)))
            .into_future()
            .from_err()
            .and_then(move |_| {
                state
            ...
            .from_err()
            .and_then(move |_| ok(HttpResponse::Ok().json(api::Response::data(api::NoData {}))))
