...
pub fn put(note_id: web::Path<(uuid::Uuid)>, note_data: web::Json<models::UpdateNote>, state: web::Data<api::State>, req: HttpRequest)
-> impl Future<Item = HttpResponse, Error = Error> {
    ...
    return Either::B(
        state.db.send(controllers::UpdateNote{
