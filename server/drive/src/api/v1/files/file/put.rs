...
pub fn put(file_id: web::Path<(uuid::Uuid)>, file_data: web::Json<models::UpdateFileBody>, state: web::Data<api::State>, req: HttpRequest)
-> impl Future<Item = HttpResponse, Error = Error> {
    ...
    return Either::B(
        state.db.send(controllers::UpdateFile{
        ...
        .and_then(move |res| {
            match res {
                Ok(file) => {
                    let res: models::FileResponse = file.into();
