...
pub fn post(restore_data: web::Json<models::RestoreFilesBody>, state: web::Data<api::State>, req: HttpRequest)
-> impl Future<Item = HttpResponse, Error = Error> {
    ...
    return Either::B(
        state.db
        .send(controllers::RestoreFiles{
            files: restore_data.files.clone(),
