...
pub fn post(album_id: web::Path<(uuid::Uuid)>, remove_data: web::Json<models::RemoveFromAlbumBody>, state: web::Data<api::State>, req: HttpRequest)
-> impl Future<Item = HttpResponse, Error = Error> {
    ...
    return Either::B(
        state.db.send(controllers::RemoveFilesFromAlbum{
            files: remove_data.media.clone(),
