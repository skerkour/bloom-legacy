...
pub fn post(album_id: web::Path<(uuid::Uuid)>, add_data: web::Json<models::AddToAlbumBody>, state: web::Data<api::State>, req: HttpRequest)
-> impl Future<Item = HttpResponse, Error = Error> {
    ...
    return Either::B(
        state.db.send(controllers::AddFilesToAlbum{
