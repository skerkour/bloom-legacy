...
fn main() {
    ...
    HttpServer::new(move || {
        ...
        .service(web::resource("/myaccount/v1/registration/start")
            .route(web::post().to_async(accountsv1::registration::start::post))
        )
        .service(web::resource("/myaccount/v1/registration/verify")
            .route(web::post().to_async(accountsv1::registration::verify::post))
        )
        .service(web::resource("/myaccount/v1/registration/complete")
            .route(web::post().to_async(accountsv1::registration::complete::post))
        )
        .service(web::resource("/myaccount/v1/registration/new-code")
            .route(web::post().to_async(accountsv1::registration::new_code::post))
        )
        .service(web::resource("/myaccount/v1/sign-in")
            .route(web::post().to_async(accountsv1::sign_in::post))
        )
        .service(web::resource("/myaccount/v1/sign-out")
            .route(web::post().to_async(accountsv1::sign_out::post))
        )
        ...
        .service(web::resource("/myaccount/v1/me/password")
            .route(web::put().to_async(accountsv1::me::password::put))
        )
        .service(web::resource("/myaccount/v1/me/avatar")
            .route(web::put().to_async(accountsv1::me::avatar::put))
        )
        .service(web::resource("/myaccount/v1/me/email")
            .route(web::put().to_async(accountsv1::me::email::put))
        )
        .service(web::resource("/myaccount/v1/me/email/verify")
            .route(web::post().to_async(accountsv1::me::email::verify::post))
        )
        ...
        .service(web::resource("/myaccount/v1/me/sessions/{session_id}/revoke")
            .route(web::post().to_async(accountsv1::me::sessions::revoke::post))
        )
        ...
        .service(web::resource("/drive/v1/me")
            .route(web::get().to_async(drivev1::me::get))
        )
        ...
        .service(web::resource("/drive/v1/files/{file_id}/url")
            .route(web::get().to_async(drivev1::files::url::get))
        )
        .service(web::resource("/drive/v1/files/move")
            .route(web::post().to_async(drivev1::files::move_::post))
        )
        .service(web::resource("/drive/v1/files/restore")
            .route(web::post().to_async(drivev1::files::restore::post))
        )
        .service(web::resource("/drive/v1/files/delete")
            .route(web::post().to_async(drivev1::files::delete::post))
        )
        .service(web::resource("/drive/v1/files/copy")
            .route(web::post().to_async(drivev1::files::copy::post))
        )
        ...
        .service(web::resource("/bitflow/v1/downloads/remove")
            .route(web::post().to_async(bitflowv1::downloads::remove::post))
        )
        ...
        .service(web::resource("/bitflow/v1/downloads/{download_id}/complete")
            .route(web::post().to_async(bitflowv1::downloads::download::complete::post))
        )
        .service(web::resource("/bitflow/v1/downloads/{download_id}/fail")
            .route(web::post().to_async(bitflowv1::downloads::download::fail::post))
        )
        ...
        .service(web::resource("/bitflow/v1/job")
            .route(web::get().to_async(bitflowv1::job::get))
        )
        ...
        .service(web::resource("/notes/v1/notes/{note_id}/archive")
            .route(web::post().to_async(notesv1::notes::archive::post))
        )
        .service(web::resource("/notes/v1/notes/{note_id}/unarchive")
            .route(web::post().to_async(notesv1::notes::unarchive::post))
        )
        .service(web::resource("/notes/v1/notes/{note_id}/remove")
            .route(web::post().to_async(notesv1::notes::remove::post))
        )
        .service(web::resource("/notes/v1/notes/{note_id}/restore")
            .route(web::post().to_async(notesv1::notes::restore::post))
        )
        .service(web::resource("/notes/v1/archive")
            .route(web::get().to_async(notesv1::archive::get))
        )
        .service(web::resource("/notes/v1/trash")
            .route(web::get().to_async(notesv1::trash::get))
        )


        // music
        .service(web::resource("/music/v1/musics")
            .route(web::get().to_async(musicv1::musics::get))
        )
        ...
        .service(web::resource("/music/v1/playlists/{playlist_id}/add")
            .route(web::post().to_async(musicv1::playlists::playlist::add::post))
        )
        .service(web::resource("/music/v1/playlists/{playlist_id}/remove")
            .route(web::post().to_async(musicv1::playlists::playlist::remove::post))
        )

        // gallery
        .service(web::resource("/gallery/v1/media")
            .route(web::get().to_async(galleryv1::media::get))
        )
        ...
        .service(web::resource("/gallery/v1/albums/{album_id}/add")
            .route(web::post().to_async(galleryv1::albums::album::add::post))
        )
        .service(web::resource("/gallery/v1/albums/{album_id}/remove")
            .route(web::post().to_async(galleryv1::albums::album::remove::post))
        )
        ...
        .service(web::resource("/phaser/v1/scans/{scan_id}")
            .route(web::delete().to_async(phaserv1::scans::scan::delete))
        )
        .service(web::resource("/phaser/v1/scans/{scan_id}/queue")
            .route(web::post().to_async(phaserv1::scans::scan::queue::post))
        )
        .service(web::resource("/phaser/v1/scans/{scan_id}/cancel")
            .route(web::post().to_async(phaserv1::scans::scan::cancel::post))
        )
        .service(web::resource("/phaser/v1/scans/{scan_id}/reports/{report_id}/complete")
            .route(web::post().to_async(phaserv1::scans::scan::reports::report::complete::post))
        )
    })
    .backlog(8192)
    .keep_alive(60)
