...
fn main() {
    ...
    HttpServer::new(move || {
        ...
        .wrap(middleware::DefaultHeaders::new()
            ...
            .header("Content-Security-Policy", "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data:; connect-src 'self' https://sentry.io/1316998 https://sentry.io/api/1316998; report-uri https://sentry.io/api/1316998/security/?sentry_key=db4dde9412754e5988de21c84d5337d4")
        )
