...
pub fn post((download_data, req): (Json<models::QueueDownloadBody>, HttpRequest<api::State>)) -> FutureResponse<HttpResponse> {
    ...
    return state.db
    .send(controllers::QueueDownload{
        url: download_data.url.clone(),
