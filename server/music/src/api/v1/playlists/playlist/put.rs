...
pub fn put(playlist_id: web::Path<(uuid::Uuid)>, playlist_data: web::Json<models::UpdatePlaylistBody>, state: web::Data<api::State>, req: HttpRequest)
-> impl Future<Item = HttpResponse, Error = Error> {
    ...
    return Either::B(
        state.db.send(controllers::RenamePlaylist{
