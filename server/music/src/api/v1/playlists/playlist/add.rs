...
pub fn post(playlist_id: web::Path<(uuid::Uuid)>, add_data: web::Json<models::AddToPlaylistBody>, state: web::Data<api::State>, req: HttpRequest)
-> impl Future<Item = HttpResponse, Error = Error> {
    ...
    return Either::B(
        state.db.send(controllers::AddFilesToPlaylist{
