...
pub fn post(playlist_id: web::Path<(uuid::Uuid)>, remove_data: web::Json<models::RemoveFromPlaylistBody>, state: web::Data<api::State>, req: HttpRequest)
-> impl Future<Item = HttpResponse, Error = Error> {
    ...
    return Either::B(
        state.db.send(controllers::RemoveFilesFromPlaylist{
            files: remove_data.musics.clone(),
