<template>
  ...
  <v-container class="mt-4 text-center">
    <v-row class="justify-center">
      ...
      <v-col cols="12" sm="10" md="8" class="text-left mb-4">
        <div>
            <p class="mb-3"><i>
            ...
            <p>
              All user data is safely stored in France, Europe on <a href="https://www.scaleway.com/en/" target="_blank" rel="noopener">Scaleway</a>. Other than financial details we do not transfer data outside
              of France.
            </p>
            ...
            <p>
              ...
              <ul>
                ...
                <li>We  engage with our comunity to learn directly from them how they use our products rather than using <b>analytics trackers</b></li>
