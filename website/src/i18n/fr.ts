export default {
  labels: {
    ...
    pain2: "Fatigué d'être abusé par les grosses compagnies?",
    pain3: 'Vous avez perdu toute confiance dans les GAFAM?',
    pain4: 'La vie privée n\'est pas morte!',
  },
  appbar: {
  ...
  landing: {
    ...
    feature3: {
      title: 'Synchronisé avec tous vos appareils',
      description: `Il est simple d'emmener son contenu partout. Commencez sur votre ordinateur
        puis éditez sur votre smartphone. Bloom fonctionne sur n'importe quel appareil ou plateforme. Même la ligne de commande!`,
    },
    product_hunt: '#1 Produit du jour',
    hacker_news: '#1 sur',
  },
  p404: {
