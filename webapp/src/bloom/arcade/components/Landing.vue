<template>
  ...
  <section id="main-section">
    <div>
      <img id="hero-image" src="/arcade/static/imgs/landing/gaming.svg" />
    </div>
    <v-container>
      <v-layout row wrap>
            ...
            <v-layout row wrap>
              <v-flex xs12>
                <h2 class="blm-primary-title">
                  <span class="rounded-elegance">Bloom</span> Arcade
                </h2>
    ...
    <section class="text-xs-center">
        ...
        <v-container>
          <v-layout row wrap>
            <v-flex xs12>
              <p class="blm-primary-desc">
                Get started with Bloom Arcade for free
              </p>
              <v-btn to="/register" color="blue" dark>
                Go to Bloom Arcade
              </v-btn>
