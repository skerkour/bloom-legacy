...
type Billing interface {
	...
	GetBillingData(context.Context, *Empty) (*BillingData, error)
}
...
func (c *billingProtobufClient) GetBillingData(ctx context.Context, in *Empty) (*BillingData, error) {
	ctx = ctxsetters.WithPackageName(ctx, "com.bloom42.billing")
	ctx = ctxsetters.WithServiceName(ctx, "Billing")
	ctx = ctxsetters.WithMethodName(ctx, "GetBillingData")
	out := new(BillingData)
...
func (c *billingJSONClient) GetBillingData(ctx context.Context, in *Empty) (*BillingData, error) {
	ctx = ctxsetters.WithPackageName(ctx, "com.bloom42.billing")
	ctx = ctxsetters.WithServiceName(ctx, "Billing")
	ctx = ctxsetters.WithMethodName(ctx, "GetBillingData")
	out := new(BillingData)
...
func (s *billingServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	case "/twirp/com.bloom42.billing.Billing/UpdateDefaultPaymentMethod":
		...
		return
	case "/twirp/com.bloom42.billing.Billing/GetBillingData":
		s.serveGetBillingData(ctx, resp, req)
		return
	default:
...
func (s *billingServer) serveGetBillingData(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveGetBillingDataJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveGetBillingDataProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *billingServer) serveGetBillingDataJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetBillingData")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	// Call service method
	var respContent *BillingData
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = s.Billing.GetBillingData(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *BillingData and nil error while calling GetBillingData. nil responses are not supported"))
		return
	}
...
func (s *billingServer) serveGetBillingDataProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetBillingData")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
