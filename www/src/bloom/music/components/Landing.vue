<template>
  ...
  <section id="main-section">
    <div>
      <img id="hero-image" src="/music/static/imgs/landing/music.svg" />
    </div>
    <v-container>
      <v-layout row wrap>
            ...
            <v-layout row wrap>
              <v-flex xs12>
                <h2 class="blm-primary-title">
                  <span class="rounded-elegance">Bloom</span> Music
                </h2>
                <p class="blm-primary-desc">
                  A world of emotion. <br/>
    ...
    <section class="text-xs-center">
        ...
        <v-container>
          <v-layout row wrap>
            <v-flex xs12>
              <p class="blm-primary-desc">
                Get started with Bloom Music for free
              </p>
              <v-btn to="/register" color="blue" dark>
                Go to Bloom Music
              </v-btn>
  ...
  services = [
    {
      ...
      logo: '/music/static/imgs/landing/devices.svg',
    ...
    },
    {
      ...
      logo: '/music/static/imgs/landing/walking.svg',
    ...
    },
    {
      ...
      logo: '/music/static/imgs/landing/organized.svg',
